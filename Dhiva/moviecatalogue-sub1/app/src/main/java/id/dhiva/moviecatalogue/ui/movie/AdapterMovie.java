...
public class AdapterMovie extends RecyclerView.Adapter<AdapterMovie.ViewHolder>{
    ...
    void setData(ArrayList<ModelItem> items) {
        dataFilm.clear();
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdapterMovie.ViewHolder holder, int position) {
       holder.bind(dataFilm.get(position));
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onItemClickCallback.onItemClicked(dataFilm.get(holder.getAdapterPosition()));
            }
        });
    }
    ...
    public interface OnItemClickCallback{
        void onItemClicked(ModelItem data);
    }
