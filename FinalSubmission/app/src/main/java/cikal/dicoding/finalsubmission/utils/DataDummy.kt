package cikal.dicoding.finalsubmission.utils
...
object DataDummy {
    ...
    fun generateDummyRemoteMovies(): ArrayList<MovieResponse> {
    ...
    fun generateDummyRemoveTvShows(): ArrayList<TvShowResponse> {
